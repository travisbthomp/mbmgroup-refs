...
%% Setting paths 
% User will need to set paths here 

% path to ADNI directory
data_dir = '/Volumes/Pavan_SSD/Connectome_atrophy/Data/LMCI/LMCI/tauPET/'; % USER SPECIFIED

% path to ADNI csv file containing subject information
csv_path = '/Volumes/Pavan_SSD/Connectome_atrophy/Data/LMCI/LMCI/tauPET/LMCI_MRImatched_ABTAUPET_6_17_2020.csv'; % USER SPECIFIED

brain_mask_path = '/Volumes/Pavan_SSD/matlab_pkgs/spm12/tpm/mask_ICV.nii'; % USER SPECIFIED
...
% These may need to be changed depending on your paths 
...
tpm = spm_vol('/Volumes/Pavan_SSD/matlab_pkgs/spm12/tpm/labels_Neuromorphometrics.nii'); % USER SPECIFIED
f = 'i1 >= 38 & i1 <= 41 ';
